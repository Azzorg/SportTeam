...
import { AddMatchPage } from '../addMatch/addMatch';
...
export class CalendarPage {
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams, public parserDB: ParserBDDProvider) {
    //Récupération des matchs inscrits dans la db
    //this.onGetMatchs();
    this.listMatch = this.parserDB.getAllMatchs();

    console.log("Nb match from db :", this.listMatch);
   ...
   /* this.player1 = new Player(); 
    ...
    /*if(this.navParams.get("match") != null){
      ...
      this.listMatch.push(this.match);
  ...
  /*onGetMatchs(){
    this.listMatch = this.parserJson.getMatchs();
  }*/
